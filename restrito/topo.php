...
<html>
    <head>
        ...
        <!-- Owl JavaScript -->
        <script src="../lib/owlcarousel/docs/assets/owlcarousel/owl.carousel.min.js"></script>        
        ...
        <!-- fontes site -->
        <link rel="stylesheet" type="text/css" href="../lib/fonte/stylesheet.css">

        <!-- fontes icons  -->
        <link rel="stylesheet" href="../lib/fonte/font-awesome-4.7.0/css/font-awesome.min.css">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/tcc/controller/controlerTabela.php?opcao=1">Home</a></li>
                        <li><a href="/tcc/restrito/talk.php">Talk</a></li>
                        <li class="dropdown">
