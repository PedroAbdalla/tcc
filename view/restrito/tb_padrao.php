...
<div id="tab-tb-padrao">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="#tb-Imagens" aria-controls="tb-Imagens" role="tab" data-toggle="tab" onclick="trocarAba(1, 'tb-Imagens', 1);">Imagens</a></li>
    </ul>
    <div class="tab-content">
        <div role="tb-Categorias" class="tab-pane active" id="tb-Categorias">
            <?php include_once('tb_padrao_categoria.php'); ?>
        </div>
        <div role="tb-Imagens" class="tab-pane" id="tb-Imagens">
            <?php include_once('tb_padrao_imagens.php'); ?>
        </div>
    </div>
</div>